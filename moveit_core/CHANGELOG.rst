...
* Use size_t for index variables (`#946 <https://github.com/vatanaksoytezer/moveit2/issues/946>`_)
...
* Add jerk to the robot model (`#683 <https://github.com/vatanaksoytezer/moveit2/issues/683>`_)
  * Add jerk to the robot model
  * Add joint limit parsing to a unit test
  * Add jerk to computeVariableBoundsMsg and <<, too
* collision_distance_field: Fix undefined behavior vector insertion (`#942 <https://github.com/vatanaksoytezer/moveit2/issues/942>`_)
* Normalize incoming transforms (`#2920 <https://github.com/vatanaksoytezer/moveit2/issues/2920>`_)
...
* RobotState: write to correct array (`#2909 <https://github.com/vatanaksoytezer/moveit2/issues/2909>`_)
...
* fix uninitialized orientation in default shape pose (`#2896 <https://github.com/vatanaksoytezer/moveit2/issues/2896>`_)
* Readability and consistency improvements in TOTG (`#2882 <https://github.com/vatanaksoytezer/moveit2/issues/2882>`_)
