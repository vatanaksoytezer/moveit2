...
* MPD: do not save/restore warehouse parameters (`#2865 <https://github.com/vatanaksoytezer/moveit2/issues/2865>`_)
...
* PlanningSceneDisplay: always update the main scene node's pose (`#2876 <https://github.com/vatanaksoytezer/moveit2/issues/2876>`_)
