...
* MGI: add missing replan/look options to interface (`#2892 <https://github.com/vatanaksoytezer/moveit2/issues/2892>`_)
...
* PSI: get object.pose from new msg field (`#2877 <https://github.com/vatanaksoytezer/moveit2/issues/2877>`_)
